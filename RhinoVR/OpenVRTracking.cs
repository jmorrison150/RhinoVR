...
namespace RhinoVR {
  public class OpenVRTracking {
    private static Valve.VR.HmdVector3_t[] _hmdToEyeViewOffsets = new Valve.VR.HmdVector3_t[2];
    ...
    public static double[] FovL { get { return OpenVRTracking._fovL; } }
    public static double[] FovR { get { return OpenVRTracking._fovR; } }
    public static Point3d[] CamLoc { get { return OpenVRTracking._camLoc; } }
    public static Vector3d[] CamDir { get { return OpenVRTracking._camDir; } }
    public static Vector3d[] CamUp { get { return OpenVRTracking._camUp; } }
